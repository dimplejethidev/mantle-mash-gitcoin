...
import chainlinkPng from './assets/mantlenetworkio.png'
...
export default class MyGame extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.collider(knives, lizards, this.handleKnifeLizardCollision, undefined, this)
        this.physics.add.collider(knives, demon, this.handleKnifeDemonCollision, undefined, this)
        this.physics.add.collider(knives, plantZombie, this.handleKnifeLizardCollision, undefined, this)
        this.physics.add.collider(knives, Knight, this.handleKnifeKnightCollision, undefined, this)
        this.physics.add.collider(knives, newKnights, this.handleKnifeLizardCollision, undefined, this)
        this.physics.add.collider(knives, wallsLayer, this.handleKnifewallsCollision, undefined, this)
        //this.physics.add.collider(knives, ghostt, this.handleKnifeLizardCollision, undefined, this)
        this.physics.add.collider(knives, reaperr, this.handleKnifeLizardCollision, undefined, this)
        ...
        this.physics.add.collider(wallsLayer, knives, this.handleKnifewallsCollision, undefined, this)
        ...
        this.physics.add.collider(faune, doors, this.handlePlayerDoorCollide, undefined, this)
        this.physics.add.collider(knives, wallss, this.handleknifewallCollide, undefined, this)
        this.physics.add.collider(faune, flamethrows, this.handlePlayerflamethrowCollide, undefined, this)
        this.physics.add.collider(faune, wizards, this.handlePlayerWizardCollide, undefined, this)
        this.physics.add.collider(faune, keys, this.handlePlayerKeyCollide, undefined, this)
        this.physics.add.collider(faune, chainlinks, this.handleplayerchainlinkcollide, undefined, this)
        ...
        this.physics.add.collider(faune, doorwoods, this.handlePlayerDoorwoodCollide, undefined, this)
        ...
        this.physics.add.collider(faune, flasks, this.handleplayerflaskcollide, undefined, this)
...
const loadBlockchainData = () => {
    ...
    const networkData = DungeonToken.networks["5001"]
    ...
    if (networkData) {
        ...
        window.alert('Smart contract not deployed to the mantle test network')
    }
}
